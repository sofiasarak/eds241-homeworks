...
1. When a turbine is proposed or becomes operational, that may lead to an influx of new residents that hope to find jobs maintaining the wind turbine. It is possible that this influx of residents comes from a specific political background (for example, people who work on wind farms are more likely to be liberal), skewing the results. This is confounding because change in liberal party voting share comes from this new population, and not from the people who had lived there before.

2. Rural areas tend to have a higher proportion of conservative-minded people. People of a liberal viewpoint may be surrounded by those with an opposite opinion, making it easier to vote conservative if there is a big nuisance that is developed in their neighborhood, thanks to the liberal party. This confounds the results because liberal party voting share in has the influence of neighbors' opinions, instead of just people's own thoughts on the wind turbine.
...
*Response:* The study addresses the risk of spillovers by calculating the average treatment effect within precinct groups 1km-increments away from proposed or operational turbines. (The idea being, that people do not like visible infrastructure). They find that, for both proposed and operational wind turbines, vote share declines can be detected in precincts up to 3 km away from the turbines. For precincts 4 and 5 km away from the turbines, the effects are indistinguishable. This serves as a spillover test, and can be used in the interpretation of results.
